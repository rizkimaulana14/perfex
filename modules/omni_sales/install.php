...
if (!$CI->db->field_exists('pay_mode_id' ,db_prefix() . 'omni_customer_report')) {
    $CI->db->query('ALTER TABLE `' . db_prefix() . 'omni_customer_report`
      ADD COLUMN `pay_mode_id` int(11) NULL
  ');
}


/*update for client in Kenya END*/
