         ...
         <div class="col-md-6">
            ...
            <div class="form-group">
               ...
               <div class="input-group">
                  ...
                  <input type="text" name="number" class="form-control" value="<?php echo html_entity_decode($_invoice_number); ?>" data-isedit="<?php echo html_entity_decode($isedit); ?>" data-original-number="<?php echo html_entity_decode($data_original_number); ?>">
                  <?php if($format == 3) { ?>
                  <span class="input-group-addon">
                     ...
                     <div class="form-group select-placeholder"<?php if(isset($invoice) && !empty($invoice->is_recurring_from)){ ?> data-toggle="tooltip" data-title="<?php echo _l('create_recurring_from_child_error_message', [_l('invoice_lowercase'),_l('invoice_lowercase'), _l('invoice_lowercase')]); ?>"<?php } ?>>
                        ...
                        >
                           ...
                           <?php
                              ...
                              ?>
                           <option value="<?php echo html_entity_decode($i); ?>" <?php echo html_entity_decode($selected); ?>><?php echo html_entity_decode($reccuring_string); ?></option>
                           <?php } ?>
                  ...
                  <div id="cycles_wrapper" class="<?php if(!isset($invoice) || (isset($invoice) && $invoice->recurring == 0)){echo ' hide';}?>">
                     <div class="col-md-12">
                        ...
                        <div class="form-group recurring-cycles">
                          ...
                          <div class="input-group">
                            <input type="number" class="form-control"<?php if($value == 0){echo ' disabled'; } ?> name="cycles" id="cycles" value="<?php echo html_entity_decode($value); ?>" <?php if(isset($invoice) && $invoice->total_cycles > 0){echo 'min="'.($invoice->total_cycles).'"';} ?>>
              ...
              <div class="input-group input-group-select">
               <select name="task_select" data-live-search="true" id="task_select" class="selectpicker no-margin _select_input_group" data-width="100%" data-none-selected-text="<?php echo _l('bill_tasks'); ?>">
                  ...
                  <option value="<?php echo html_entity_decode($task_billable['id']); ?>"<?php if($task_billable['started_timers'] == true){ ?>disabled class="text-danger important" data-subtext="<?php echo _l('invoice_task_billable_timers_found'); ?>" <?php } else {
                     ...
                     ?>
                     data-subtext="<?php echo html_entity_decode($task_billable['rel_type'] == 'project' ? '' : $task_rel_value['name']); ?>" <?php } ?>><?php echo html_entity_decode($task_billable['name']); ?></option>
                  <?php } ?>
               </select>
               ...
               <tr>
                  ...
                  foreach($custom_fields as $cf){
                    echo '<th width="15%" align="left" class="custom_field">' . $cf['name'] . '</th>';
                     ...
                     ?>
                  <th width="10%" align="right" class="qty"><?php echo html_entity_decode($qty_heading); ?></th>
               ...
               <tr>
                  <td>
                     <div class="row">
                        ...
                        <div class="col-md-5">
                           <input type="number" data-toggle="tooltip" data-title="<?php echo _l('numbers_not_formatted_while_editing'); ?>" value="<?php if(isset($invoice)){echo html_entity_decode($invoice->adjustment); } else { echo 0; } ?>" class="form-control pull-left" name="adjustment">
                        </div>
                     </div>
                  </td>
