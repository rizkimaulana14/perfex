...
$result = data_tables_init($aColumns, $sIndexColumn, $sTable, $join, $where, [db_prefix() . 'hr_staff_contract.id_contract', 'name_contracttype', 'firstname', 'duration', 'unit', db_prefix() . 'hr_staff_contract.id_contract as id', 'lastname']);
