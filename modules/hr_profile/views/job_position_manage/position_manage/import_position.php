...
<?php 
  $file_header = array();
$file_header[] = _l('hr_position_code');
$file_header[] = _l('hr_position_name');
$file_header[] = _l('hr_job_p_id');
$file_header[] = _l('hr_job_descriptions');
$file_header[] = _l('department_id');
$file_header[] = _l('tags');
        ...
        <div class="panel_s">
          <div class="panel-body">
            ...
            <ul>
              ...
              <li>3. <?php echo _l('hr_import_job_position_code'); ?></li>
              <li>3. <?php echo _l('hr_import_job_position_group'); ?></li>
              <li>3. <?php echo _l('hr_import_job_position_department_ids'); ?></li>
              <li>3. <?php echo _l('hr_import_job_position_tag'); ?></li>
            </ul>
