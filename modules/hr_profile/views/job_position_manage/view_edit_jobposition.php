																	...
																	<td>
																		<div class="form-group">
																			<div id="inputTagsWrapper">
																				<input type="text" class="tagsinput" id="tags" name="tags" value="<?php echo (isset($commodity_item) ? prep_tags_input(get_tags_in($position_group->id,'hr_job_position')) : ''); ?>" data-role="tagsinput">
																			</div>
																		</div>
