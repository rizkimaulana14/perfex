                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group register-country-group">
                        ...
                        <select data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" data-live-search="true" name="country" class="form-control" id="country">
                            ...
                            <option value="<?php echo html_entity_decode($country['country_id']); ?>"<?php if(get_option('customer_default_country') == $country['country_id']){echo ' selected';} ?> <?php echo set_select('country', $country['country_id']); ?>><?php echo html_entity_decode($country['short_name']); ?></option>
                            <?php } ?>
                        </select>
                    </div>
