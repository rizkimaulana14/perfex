  ...
  <tbody>
    ...
    <?php 
        ...
        if($sub_group_type['group_id']){
            $group = get_wh_group_name($sub_group_type['group_id']);
            if($group){
    ...
    <tr>
        ...
        <td>
            ...
            <a href="<?php echo admin_url('warehouse/delete_sub_group/'.$sub_group_type['id']); ?>" class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
             <?php } ?>
        </td>
    </tr>
    <?php } ?>
...
<div class="modal1 fade" id="sub_group_type" tabindex="-1" role="dialog">
        <div class="modal-dialog setting-handsome-table">
          <?php echo form_open_multipart(admin_url('warehouse/sub_group'), array('id'=>'add_sub_group')); ?>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">
                        ...
                        <span class="edit-title"><?php echo _l('edit_sub_group_type'); ?></span>
                    </h4>
                </div>
...
<?php require 'modules/warehouse/assets/js/sub_group_js.php';?>
</body>
</html>
