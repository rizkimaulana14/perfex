...
<div class="modal1 fade" id="unit_type" tabindex="-1" role="dialog">
        <div class="modal-dialog setting-handsome-table">
          <?php echo form_open_multipart(admin_url('warehouse/unit_type'), array('id'=>'add_unit_type')); ?>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">
                        ...
                        <span class="edit-title"><?php echo _l('edit_unit_type'); ?></span>
                    </h4>
                </div>
...
<?php require 'modules/warehouse/assets/js/unit_js.php';?>
